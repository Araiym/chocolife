...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="" data-toggle="modal" data-target="#exampleAddProduct">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a href="{{url('admin/logout')}}" class="nav-link" data-toggle="modal" data-target="#exampleModal">
  ...
  <div class="content-wrapper">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     ...
     <div class="modal fade" id="addPicture" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            <form method="post" role="form" action="addPicture" enctype="multipart/form-data"> {{ csrf_field() }}
  <div class="form-group">
    <label for="email">Upload picture:</label>
    <input type="file" name="image" class="form-control">
    @foreach($last as $id)
    @if($loop->last)
    <input type="hidden" name="id" value="{{$id->id_sales}}">
    @endif
    @endforeach
  </div>
  <button type="submit" class="btn btn-default">Submit</button>
      ...
      <div class="modal fade" id="exampleAddProduct" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            <form id="ajax" method="post" class="form-horizontal">{{ csrf_field() }}
    <div class="form-group">
      <label class="col-sm-4 control-label">Name of Product</label>
      <div class="col-sm-10">
        <input class="form-control" name="name" id="focusedInput" type="text" placeholder="Name of Product">
      </div>
    </div>
    <div class="form-group">
      <label for="disabledInput" class="col-sm-2 control-label">Description</label>
      <div class="col-sm-10">
        <textarea name="description" class="form-control" id="disabledInput" type="text" placeholder="Description input here..." ></textarea>
      </div>
    </div>
    <fieldset>
      <div class="form-group">
        ...
        <div class="col-sm-10">
    <input id="msg" type="text" class="form-control" name="price" placeholder="Price input here...">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <select id="disabledSelect" name="category"  class="form-control">
             <option selected disabled>Please select category of product</option>
             @foreach($var as $cat)
          ...
          <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
            <a class="btn btn-primary key" href="">Continue</a>
          </div>
        </div>
      </div>
    </div>
    ...
    $(document).ready(function($) {
      ...
      $.ajax({
          url: '/admin/store',
          type: 'POST',
          data:$('#ajax').serialize() }).done(function(){
             $(document).ready(function() {
             $("#exampleAddProduct .close").click();
